      			...
      			<div class="col-md-12">
					...
					<div class="card-body font-weight-bold">
						...
						<div class="form-group">
								<label for="para">Seu Nome</label>
								<input type="text" name="nome" class="form-control" id="para" placeholder="Digite seu nome aqui">
							</div>

							<div class="form-group">
								<label for="para">Para</label>
								<input type="text" name="destinatario" class="form-control" id="para" placeholder="joao@dominio.com.br">
							</div>
